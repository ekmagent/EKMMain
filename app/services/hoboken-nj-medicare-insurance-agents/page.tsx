...
export const metadata: Metadata = {
  ...
  description:
    "Hoboken NJ Medicare insurance agents — Anthony Orner compares Supplement & Advantage plans across top carriers in Hudson County. Call 855-559-1700 for a free review.",
