...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for hearing loss patients — compare NJ Medicare Advantage plans with hearing aid and audiology benefits. Free review. Call 855-559-1700 today.",
