...
export const metadata: Metadata = {
  ...
  description:
    "Compare NJ Medicare Advantage plans with hearing aid and audiology benefits. Free plan review with a licensed broker — call 855-559-1700 to explore options.",
