...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for hearing loss patients in NJ — compare Advantage plans with hearing aid and audiology benefits at no cost. Call 855-559-1700 for a free review.",
