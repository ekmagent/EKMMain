...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for hearing loss patients — compare NJ Medicare Advantage plans with hearing aid allowances and audiology benefits at no cost. Call 855-559-1700.",
