...
export const metadata: Metadata = {
  ...
  description:
    "Medicare agents in Camden, NJ — Anthony Orner compares Medigap & Medicare Advantage plans from multiple carriers. Free, no-obligation quote. Call 855-559-1700.",
