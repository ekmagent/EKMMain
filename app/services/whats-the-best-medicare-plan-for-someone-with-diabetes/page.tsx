...
export const metadata: Metadata = {
  ...
  description:
    "Compare Medicare Supplement vs Advantage for diabetes — insulin, CGMs, A1C tests, and doctor access. Free broker review. Call 855-559-1700 for honest guidance.",
