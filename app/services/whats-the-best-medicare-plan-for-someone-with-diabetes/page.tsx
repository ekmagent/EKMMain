...
export const metadata: Metadata = {
  ...
  description:
    "Living with diabetes on Medicare? Compare Supplement vs Advantage coverage for insulin, CGMs, and A1C tests. Call 855-559-1700 for free broker guidance today.",
