...
export const metadata: Metadata = {
  ...
  description:
    "On SSDI and under 65? Over 30 states protect your Medigap rights. Compare plans with a licensed broker — call 855-559-1700 for free help today.",
      ...
      <section className="mt-12">
        ...
        <ul className="space-y-3">
          ...
          <li>
            ...
            <div className="text-sm text-gray-600 mt-4">Get free state-based counseling from your local <a href="https://www.shiphelp.org/" rel="noopener noreferrer" target="_blank" className="underline">State Health Insurance Assistance Program (SHIP)</a>.</div>
            <div className="text-sm text-gray-600 mt-4">Need state-specific help? Contact your local <a href="https://www.shiphelp.org/" rel="noopener noreferrer" target="_blank" className="text-blue-600 underline">State Health Insurance Assistance Program (SHIP)</a> for free Medicare counseling.</div>
            <div className="text-sm text-gray-600 mt-4">Get free state counseling: <a href="https://www.shiphelp.org/" rel="noopener noreferrer" target="_blank" className="text-blue-600 underline">SHIP — State Health Insurance Assistance Program</a></div>
      </section>
