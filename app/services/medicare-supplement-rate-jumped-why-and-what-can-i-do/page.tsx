...
export const metadata: Metadata = {
  ...
  description:
    "Medicare Supplement rate jumped? Learn why Medigap premiums rise and how switching to a same-letter plan can lower your cost. Free comparison: 855-559-1700.",
