...
export const metadata: Metadata = {
  ...
  description:
    "Medigap rate jumped? Learn why Medicare Supplement premiums rise and how switching to the same plan letter can lower your cost. Free comparison: 855-559-1700.",
