...
export const metadata: Metadata = {
  ...
  description:
    "Medigap rate jumped? See why Medicare Supplement premiums rise and how switching to the same plan letter with a new carrier may lower costs. Free review.",
