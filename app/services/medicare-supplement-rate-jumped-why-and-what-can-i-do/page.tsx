...
export const metadata: Metadata = {
  ...
  description:
    "Medigap premium jumped? Learn why Medicare Supplement rates rise and how switching to the same plan letter could lower your cost. Free comparison: 855-559-1700.",
