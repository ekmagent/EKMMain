...
export const metadata: Metadata = {
  ...
  description:
    "Free New Jersey Medicare broker — compare Medigap, Advantage & Part D across top carriers with no fees or pressure. Call 855-559-1700 for unbiased help today.",
