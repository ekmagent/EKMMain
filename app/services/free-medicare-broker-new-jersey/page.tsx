...
export const metadata: Metadata = {
  ...
  description:
    "Free New Jersey Medicare broker — compare Medigap, Advantage & Part D side-by-side with a licensed independent broker. No fees, no obligation. Call 855-559-1700.",
