...
export const metadata: Metadata = {
  ...
  description:
    "Medigap for Crohn's patients helps cover Part B coinsurance on biologic infusions, colonoscopies, and GI visits. Call 855-559-1700 for free guidance today.",
...
,
  {
    question: "Does Medicare cover ostomy supplies for Crohn's patients?",
    answer:
      "Yes. Medicare Part B covers medically necessary ostomy supplies for beneficiaries who have had a colostomy, ileostomy, or urinary ostomy as part of Crohn's treatment. Part B pays its share after the annual deductible, and a Medigap plan can cover the remaining coinsurance. Your supplier must be enrolled in Medicare for coverage to apply.",
  },
  {
    question: "Will Medigap help with parenteral or enteral nutrition for IBD?",
    answer:
      "Medicare Part B may cover parenteral nutrition (IV feeding) or enteral nutrition (tube feeding) when deemed medically necessary for IBD patients who cannot absorb nutrients normally. After Part B pays its portion, a Medigap plan such as Plan G can pick up the coinsurance. Documentation from your gastroenterologist is required to establish medical necessity.",
  },
  {
    question: "How do I switch to a Medigap plan if I currently have Medicare Advantage?",
    answer:
...
,
  {
    question: "Does Medicare cover nutritional support like enteral or parenteral nutrition for Crohn's patients?",
    answer:
      "Medicare may cover medically necessary enteral (tube) and parenteral (IV) nutrition for IBD patients when specific clinical criteria are met, typically under the Part B prosthetic device benefit. Coverage requires documentation from your gastroenterologist that the therapy is medically necessary. A Medigap plan can help cover the Part B coinsurance that applies to these services.",
  },
  {
    question: "Are ostomy supplies covered for Crohn's patients who've had surgery?",
    answer:
      "Yes, Medicare Part B covers medically necessary ostomy supplies for patients who have had colostomy, ileostomy, or urinary ostomy surgery. After the Part B deductible, Medicare pays its share and a Medigap plan can pick up the coinsurance. Supplies must be obtained from a Medicare-enrolled supplier.",
  },
  {
    question: "How do I switch Medigap plans if my Crohn's treatment needs change?",
    answer:
      "Outside your initial Open Enrollment Period, switching Medigap plans usually requires medical underwriting, and Crohn's disease may affect approval with some carriers. However, certain states offer annual or birthday-month switching rights, and guaranteed-issue situations can also allow a change. Call 855-559-1700 and we'll review whether you qualify to switch without underwriting.",
  }
,
  {
    question: "Does Medicare cover nutritional support for Crohn's patients who can't absorb food normally?",
    answer:
      "Medicare may cover medically necessary parenteral nutrition (intravenous feeding) and enteral nutrition (tube feeding) for IBD patients when documentation supports the medical need. Coverage typically falls under Part B's durable medical equipment and prosthetic device benefits. A Medigap plan helps cover the Part B coinsurance on these ongoing supplies.",
  },
  {
    question: "Will a Medigap plan cover ostomy supplies after Crohn's surgery?",
    answer:
      "Medicare Part B covers medically necessary ostomy supplies for patients who have had colostomy, ileostomy, or urinary ostomy surgery. After the Part B deductible, Medicare pays its share and a Medigap plan covers the remaining coinsurance. This can make a significant difference for patients who need ongoing supply replacements.",
  },
  {
    question: "Can I switch Medigap plans later if my Crohn's symptoms change?",
    answer:
...
,
  {
    question: "Does Medicare cover nutritional support like enteral or parenteral nutrition for Crohn's patients?",
    answer:
      "Medicare Part B covers medically necessary enteral (tube feeding) and parenteral (intravenous) nutrition for patients who meet specific clinical criteria, including some IBD patients. Coverage typically requires documentation that the patient cannot maintain adequate nutrition through normal means. A Medigap plan helps cover the Part B coinsurance on these supplies and services.",
  },
  {
    question: "Are ostomy supplies covered by Medicare for Crohn's patients with surgical openings?",
    answer:
      "Yes. Medicare Part B covers ostomy supplies as durable medical equipment for patients who have had colostomy, ileostomy, or urinary ostomy surgery, which is common after Crohn's-related bowel resections. After the Part B deductible, Medicare pays its share and a Medigap plan covers the remaining coinsurance.",
  },
  {
    question: "How does switching Medigap plans work if my Crohn's symptoms change?",
    answer:
...
,
  {
    question: "Does a Medigap plan cover my gastroenterologist visits for Crohn's?",
    answer:
      "Yes. Medicare Part B covers specialist office visits, including gastroenterologists, after the Part B deductible. A Medigap plan like Plan G or Plan N covers the Part B coinsurance, so you pay little to nothing out of pocket for ongoing GI care.",
  },
  {
    question: "Can I switch Medigap plans later if my Crohn's symptoms change?",
    answer:
