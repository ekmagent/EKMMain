...
export const metadata: Metadata = {
  ...
  description:
    "Switch Medigap plans any month and keep identical Plan G or N coverage at a lower premium. Free carrier comparison from a licensed broker — call 855-559-1700.",
  alternates: {
