...
export const metadata: Metadata = {
  ...
  description:
    "Switch Medigap plans any month — keep identical Plan G or N coverage and lower your premium. Free carrier comparison from a licensed broker. Call 855-559-1700.",
  alternates: {
