...
export const metadata: Metadata = {
  ...
  description:
    "Switch Medigap plans any month and keep identical Plan G or N coverage at a lower premium. Free licensed broker help — call 855-559-1700 to compare carriers.",
  alternates: {
