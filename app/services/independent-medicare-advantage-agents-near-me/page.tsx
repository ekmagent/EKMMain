...
export const metadata: Metadata = {
  ...
  description:
    "Compare every Medicare Advantage plan in your NJ county with an independent agent. Anthony Orner offers free, no-pressure consultations. Call 855-559-1700.",
