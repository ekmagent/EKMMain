...
export const metadata: Metadata = {
  ...
  description:
    "Work with an independent NJ Medicare Advantage agent who compares every major plan in your county at no cost. Call 855-559-1700 for a free review today.",
