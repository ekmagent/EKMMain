      ...
      <article className="max-w-3xl mx-auto">
        ...
        <section className="mt-10 mb-8">
          ...
          <ul className="space-y-2">
            ...
            <div className="text-sm text-gray-600 mt-4">New Jersey families can also contact the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" target="_blank" rel="noopener noreferrer" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a> for free Medicare counseling.</div>
            <div className="text-sm text-gray-600 mt-4">Free unbiased counseling: <a href="https://www.shiphelp.org/" rel="noopener noreferrer" target="_blank" className="underline">State Health Insurance Assistance Program (SHIP)</a> — trained counselors can help families navigate Medicare decisions for loved ones with Alzheimer's.</div>
            ...
            <div className="text-sm text-gray-600 mt-4">Free unbiased counseling: <a href="https://www.shiphelp.org/" rel="noopener noreferrer" target="_blank" className="underline">State Health Insurance Assistance Program (SHIP)</a> — local counselors who can help families navigate Medicare decisions for a loved one with Alzheimer's.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey families can also contact the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a> for free, unbiased Medicare counseling.</div>
      </section>
      </article>
    </>
  );
