...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for lupus patients in NJ. Anthony Orner matches plans covering biologics, labs & rheumatology. Call 855-559-1700 for a free coverage review.",
