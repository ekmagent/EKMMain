...
export const metadata: Metadata = {
  ...
  description:
    "How can I save money on your Medicare Supplement in 2026? Switch carriers, stack discounts, or change plan letters. Free 10-min rate review. Call 855-559-1700.",
