...
export const metadata: Metadata = {
  ...
  description:
    "Kidney disease Medicare help — a licensed broker compares ESRD, dialysis, and transplant coverage at no cost. Avoid gaps. Call 855-559-1700 for a free review.",
