...
export const metadata: Metadata = {
  ...
  description:
    "Talk to a licensed Medicare broker in Cherry Hill, NJ. Anthony Orner compares Supplement and Advantage plans across top carriers — free, no-obligation help.",
...
export default function MedicareInsuranceAgentsCherryHillNJ() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      <LocalServiceSchema citySlug="cherry-hill" />
      ...
      <section className="mt-10">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Skilled nursing facility coinsurance (days 21-100): $217.00/day
          </li>
          <li>
