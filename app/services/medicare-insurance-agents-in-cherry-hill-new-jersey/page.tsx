...
export const metadata: Metadata = {
  ...
  description:
    "Medicare insurance agents in Cherry Hill, NJ — compare Medigap and Advantage plans across top carriers with Anthony Orner. Free, no-obligation help. Call 855-559-1700.",
