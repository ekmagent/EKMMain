...
export const metadata: Metadata = {
  ...
  description:
    "Apply for Medicare Supplement online during your 6-month guaranteed-issue window—no exam, no health questions. Call 855-559-1700 for free broker help today.",
