...
export const metadata: Metadata = {
  ...
  description:
    "How much does Medicare Supplement cost per month for seniors? Compare Plan G and N pricing methods by age, zip, and carrier. Call 855-559-1700 for a free quote.",
      ...
      <section className="mt-10 mb-4">
        ...
        <ul className="space-y-2">
          ...
          <li>
            ...
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can get free unbiased help through <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="text-blue-600 underline">NJ State Health Insurance Assistance Program (SHIP)</a>.</div>
      </section>
    </main>
  );
}