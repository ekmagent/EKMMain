...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker help for people with pre-existing conditions — compare lenient carriers, Medigap rules & guaranteed issue rights. Free guidance: 855-559-1700.",
