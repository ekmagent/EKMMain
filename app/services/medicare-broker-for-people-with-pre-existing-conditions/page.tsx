...
export const metadata: Metadata = {
  ...
  description:
    "Have a pre-existing condition? A licensed Medicare broker compares Medigap underwriting, guaranteed issue rights, and Advantage plans free. Call 855-559-1700.",
