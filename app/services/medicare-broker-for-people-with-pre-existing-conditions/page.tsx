...
export const metadata: Metadata = {
  ...
  description:
    "Have a pre-existing condition? A licensed Medicare broker explains Medigap underwriting, guaranteed issue rights & Advantage options. Free help — call 855-559-1700.",
