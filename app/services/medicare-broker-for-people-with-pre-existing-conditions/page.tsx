...
export const metadata: Metadata = {
  ...
  description:
    "Have a pre-existing condition? A licensed Medicare broker helps you find lenient carriers, guaranteed issue rights, and plans with no health questions. Call 855-559-1700.",
