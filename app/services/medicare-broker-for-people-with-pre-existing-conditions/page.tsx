...
export const metadata: Metadata = {
  ...
  description:
    "Pre-existing condition? A licensed Medicare broker compares Medigap underwriting rules, guaranteed issue rights & Advantage options — free. Call 855-559-1700.",
