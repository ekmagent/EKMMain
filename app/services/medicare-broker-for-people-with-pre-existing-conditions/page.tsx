...
export const metadata: Metadata = {
  ...
  description:
    "Have a pre-existing condition? A licensed Medicare broker explains Medigap underwriting, guaranteed issue rights, and Advantage options—free. Call 855-559-1700.",
