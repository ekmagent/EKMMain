...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for pre-existing conditions — find lenient carriers, guaranteed issue rights, and plans without health questions. Free help: call 855-559-1700.",
