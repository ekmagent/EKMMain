...
export const metadata: Metadata = {
  ...
  description:
    "Pre-existing condition? A licensed Medicare broker compares Medigap underwriting, guaranteed issue rights & Advantage options at no cost. Call 855-559-1700.",
