...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for schizophrenia patients — Anthony Orner compares plans covering antipsychotics & psychiatric care. Call 855-559-1700 for free help today.",
