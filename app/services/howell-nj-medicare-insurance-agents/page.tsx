...
export const metadata: Metadata = {
  ...
  description:
    "Howell NJ Medicare insurance agents — compare Supplement and Advantage plans from top carriers at no cost. Call 855-559-1700 for a free personalized quote today.",
