...
export const metadata: Metadata = {
  ...
  description:
    "Compare the best Medicare Supplement options for people on disability under 65 — state rules, plan letters, and eligibility. Call 855-559-1700 for free help.",
