...
export const metadata: Metadata = {
  ...
  description:
    "Best Medicare Supplement for people on disability: compare state rules, plan letters, and eligibility. Call 855-559-1700 for free licensed broker guidance.",
