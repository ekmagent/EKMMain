...
,
  {
    question: "Do I need to switch from my current Medigap plan to enroll in Plan G at 69?",
    answer:
      "If you already have a Medigap policy, you can apply to switch to Plan G, but outside your initial open enrollment window you'll typically need to answer health questions. The new policy doesn't start until it's approved, so don't drop your current coverage first. A broker can help you compare your current benefits against Plan G before you apply.",
  },
  {
    question: "Can I be charged more for Plan G at 69 because of my health?",
    answer:
      "Outside your Medigap Open Enrollment Period, insurers can use medical underwriting to decide whether to approve you and at what rate. Tobacco use and certain health conditions may result in higher premiums or a declined application. Comparing multiple carriers improves your odds of finding favorable pricing.",
  },
  {
      ...
      <section className="mt-12">
        ...
        <ul className="space-y-2">
          ...
          <li>
            ...
            <div className="text-sm text-gray-600 mt-4">Need state-specific guidance? Find your local <a href="https://www.shiphelp.org/" rel="noopener noreferrer" target="_blank" className="underline">State Health Insurance Assistance Program (SHIP)</a> for free Medicare counseling, or call 855-559-1700.</div>
            <div className="text-sm text-gray-600 mt-4">For state-specific Medigap rules and free counseling, contact your <a href="https://www.shiphelp.org/" rel="noopener noreferrer" target="_blank" className="underline">local SHIP program</a> or the <a href="https://www.state.nj.us/dobi/" rel="noopener noreferrer" target="_blank" className="underline">NJ Department of Banking and Insurance</a>.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can get free, unbiased counseling from <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="text-blue-600 underline">NJ SHIP (State Health Insurance Assistance Program)</a> or contact the <a href="https://www.state.nj.us/dobi/" rel="noopener noreferrer" target="_blank" className="text-blue-600 underline">NJ Department of Banking and Insurance</a>.</div>
            ...
            <div className="text-sm text-gray-600 mt-4">State help: <a href="https://www.shiphelp.org/" rel="noopener noreferrer" target="_blank" className="underline">Find your local SHIP counselor</a> for free, unbiased Medicare guidance in your state.</div>
            ...
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can contact the <a href="https://www.state.nj.us/dobi/division_insurance/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a> for free counseling.</div>
      </section>
    </main>
  );
}