...
export const metadata: Metadata = {
  ...
  description:
    "Enroll in Medicare Supplement Plan G at 69 with licensed broker help. Compare carriers, navigate underwriting, and apply with confidence. Call 855-559-1700.",
