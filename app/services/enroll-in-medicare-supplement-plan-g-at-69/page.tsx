...
export const metadata: Metadata = {
  ...
  description:
    "Enrolling in Medicare Supplement Plan G at 69? Get free licensed broker help comparing carriers and underwriting. Call 855-559-1700 for no-obligation quotes.",
