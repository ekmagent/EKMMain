...
export const metadata: Metadata = {
  ...
  description:
    "Medigap premium hikes draining your budget? Compare carriers on the same plan letter and call 855-559-1700 for a free rate review to lower your monthly costs.",
