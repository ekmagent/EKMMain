...
export const metadata: Metadata = {
  ...
  description:
    "Facing a Medigap rate hike? Compare carriers offering the same plan letter and call 855-559-1700 for a free, no-pressure rate review to protect your budget.",
