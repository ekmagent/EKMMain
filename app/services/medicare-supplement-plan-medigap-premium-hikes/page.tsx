...
export const metadata: Metadata = {
  ...
  description:
    "Worried about a Medigap premium hike? Learn why rates rise, when you can switch carriers without underwriting, and call 855-559-1700 for a free rate review.",
