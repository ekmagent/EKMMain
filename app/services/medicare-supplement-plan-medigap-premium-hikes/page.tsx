...
export const metadata: Metadata = {
  ...
  description:
    "Medigap premium hikes squeezing your budget? Learn why rates rise, when to switch carriers, and lock in savings with a free rate review — call 855-559-1700.",
