...
export const metadata: Metadata = {
  ...
  description:
    "Medigap premium hikes squeezing your budget? Learn why rates rise, when you can switch carriers, and call 855-559-1700 for a free no-pressure rate review.",
