...
export const metadata: Metadata = {
  ...
  description:
    "Medigap premium hikes squeezing your budget? Learn why rates rise, when to switch carriers, and how to lock in savings. Free rate review — call 855-559-1700.",
