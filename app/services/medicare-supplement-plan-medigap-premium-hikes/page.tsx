...
export const metadata: Metadata = {
  ...
  description:
    "Hit with a Medigap rate hike? Compare carriers on the same plan letter and call 855-559-1700 for a free rate review to help stabilize your monthly premium.",
