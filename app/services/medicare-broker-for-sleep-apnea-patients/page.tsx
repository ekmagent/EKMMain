...
export const metadata: Metadata = {
  ...
  description:
    "Licensed Medicare broker for sleep apnea patients. Get CPAP coverage, 90-day compliance, and DME supplier guidance. Free plan review — call 855-559-1700.",
