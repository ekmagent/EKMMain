...
export const metadata: Metadata = {
  ...
  description:
    "Talk to a licensed Medicare broker in Bayonne, NJ. Anthony Orner compares Medigap and Advantage plans at no cost to you. Free local consult — call 855-559-1700.",
