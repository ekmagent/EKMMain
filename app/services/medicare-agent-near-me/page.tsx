...
export const metadata: Metadata = {
  ...
  description:
    "Medicare agent near me — Anthony Orner, licensed in NJ & 34 states, compares plans across 30+ carriers at no cost. Free phone, video, or in-person help. Call today.",
