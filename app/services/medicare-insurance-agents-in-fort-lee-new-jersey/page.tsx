...
export const metadata: Metadata = {
  ...
  description:
    "Talk with a licensed Medicare broker serving Fort Lee, NJ. Anthony Orner compares Medigap and Advantage plans across Bergen County — free help. Call 855-559-1700.",
