...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for bipolar disorder patients — Anthony Orner compares plans covering mood stabilizers, therapy, and psychiatric care. Free review: 855-559-1700.",
