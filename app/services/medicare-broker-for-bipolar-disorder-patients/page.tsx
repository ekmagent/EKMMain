...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for bipolar disorder patients — Anthony Orner compares NJ plans covering mood stabilizers, therapy, and psychiatric care. Call 855-559-1700.",
