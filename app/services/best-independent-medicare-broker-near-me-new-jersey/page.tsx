...
,
  {
    ...
    answer:
      "You can confirm a broker's license through the New Jersey Department of Banking and Insurance producer search tool. Anthony Orner is licensed in New Jersey (NPI 1902584006) and 34 additional states. Always verify credentials before sharing personal information or enrolling in a plan.",
  },
  {
    question: "Does New Jersey use community rating for Medigap premiums?",
    answer:
      "Yes. New Jersey uses community rating, which means Medigap carriers charge the same premium to everyone with a given plan regardless of age. However, guaranteed issue protections still primarily apply during your 6-month Medigap Open Enrollment Period, not year-round.",
  },
  {
    question: "Will a broker help me review my plan every year?",
    answer:
      "Yes. Plans change benefits, formularies, and pricing every year during the Annual Enrollment Period from October 15 to December 7. Anthony Orner reviews client plans annually to make sure your coverage still fits your doctors, prescriptions, and budget at no cost to you.",
  }
,
  {
    question: "Does New Jersey have special Medigap rules I should know about?",
    answer:
      "Yes. New Jersey uses community rating for Medigap, meaning carriers set the same base premium regardless of your age. Your strongest enrollment window is still the 6-month Medigap Open Enrollment Period that begins when you're 65 and enrolled in Part B. Outside that window, medical underwriting may apply.",
  },
  {
    question: "How do I switch brokers if I already have a Medicare plan?",
    answer:
      "You can change your broker of record at any time by signing a new agent of record form, and it costs you nothing. Your plan, premium, and benefits stay exactly the same — only the agent who services your policy changes. Anthony Orner can walk you through the simple paperwork by phone.",
  }
,
  {
...
,
  {
    question: "Does New Jersey use community rating for Medigap premiums?",
    answer:
      "Yes. New Jersey requires community-rated Medigap pricing, meaning carriers charge the same base premium regardless of your age at the time of enrollment. Rates can still vary by carrier, plan letter, and factors like tobacco use, so comparing multiple carriers matters.",
  },
  {
      ...
      <article className="max-w-3xl mx-auto">
        ...
        <section className="mt-10 mb-8">
          ...
          <ul className="space-y-2">
            ...
            <div className="text-sm text-gray-600 mt-4">Free unbiased NJ counseling is also available through <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">New Jersey SHIP (State Health Insurance Assistance Program)</a>.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey help: <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a></div>
      </section>
      </article>
    </>
