...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for chronic pain patients: Anthony Orner compares plans covering pain management, PT, injections, and specialists. Free review — call 855-559-1700.",
