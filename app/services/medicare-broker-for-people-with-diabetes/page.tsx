...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for people with diabetes — Anthony Orner compares plans covering insulin, CGMs & endocrinologists. Free help, no obligation. Call 855-559-1700.",
