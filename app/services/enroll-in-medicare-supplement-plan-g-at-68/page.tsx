...
export const metadata: Metadata = {
  ...
  description:
    "Enroll in Medicare Supplement Plan G at 68 with expert broker guidance on underwriting, carrier rates, and timing. Call 855-559-1700 for a free plan review.",
