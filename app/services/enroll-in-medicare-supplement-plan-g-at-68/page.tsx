...
export const metadata: Metadata = {
  ...
  description:
    "Enrolling in Medicare Supplement Plan G at 68? Compare carriers, navigate underwriting, and lock in stable coverage. Call 855-559-1700 for free expert guidance.",
