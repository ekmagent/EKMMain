...
export const metadata: Metadata = {
  ...
  description:
    "Local Medicare agents in Union, NJ — Anthony Orner compares Medigap & Advantage plans across top carriers at no cost to you. Call 855-559-1700 for a free quote.",
