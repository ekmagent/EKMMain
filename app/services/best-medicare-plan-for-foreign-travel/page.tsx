...
export const metadata: Metadata = {
  ...
  description:
    "Compare the best Medicare plans for foreign travel. Medigap Plans G & N include emergency coverage abroad — free guidance from a licensed broker. Call today.",
