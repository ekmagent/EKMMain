...
export const metadata: Metadata = {
  ...
  description:
    "Compare the best Medicare plans for foreign travel. Medigap Plans G and N include emergency coverage abroad — get a free comparison from a licensed broker.",
