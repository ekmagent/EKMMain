...
export const metadata: Metadata = {
  ...
  description:
    "Compare every top Medicare carrier with a licensed broker serving Egg Harbor Township, NJ. Free, unbiased plan help — call 855-559-1700 for your quote today.",
