...
export const metadata: Metadata = {
  ...
  description:
    "Hillsborough NJ Medicare agents compare Supplement & Advantage plans from top carriers at no cost to you. Call 855-559-1700 for a free Somerset County quote.",
