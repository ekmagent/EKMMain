      ...
      <section className="mt-12">
        ...
        <ul className="space-y-3">
          ...
          <li>
            ...
            <div className="text-sm text-gray-600 mt-4">Florida residents can also contact <a href="https://www.floir.com/" rel="noopener noreferrer" target="_blank" className="underline">the Florida Office of Insurance Regulation</a> or the <a href="https://www.floridashine.org/" rel="noopener noreferrer" target="_blank" className="underline">Florida SHINE program</a> for free, unbiased Medicare counseling.</div>
            <div className="text-sm text-gray-600 mt-4">Florida residents can also get free, unbiased counseling from <a href="https://www.floridashine.org/" rel="noopener noreferrer" target="_blank" className="underline">SHINE (Florida's SHIP program)</a> or verify a broker's license with the <a href="https://www.myfloridacfo.com/division/agents" rel="noopener noreferrer" target="_blank" className="underline">Florida Department of Financial Services</a>.</div>
      </section>
    </main>
  );
}