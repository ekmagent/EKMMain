...
export const metadata: Metadata = {
  ...
  description:
    "Medicare consultant in Ft Lauderdale, FL — Anthony Orner compares Supplement & Advantage plans across Broward County carriers. Free review. Call 855-559-1700.",
