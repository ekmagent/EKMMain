...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for dialysis patients — free ESRD plan reviews, home dialysis guidance, and no-cost enrollment help. Call 855-559-1700 to compare plans today.",
