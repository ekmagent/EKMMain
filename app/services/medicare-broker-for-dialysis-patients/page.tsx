...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for dialysis patients — free ESRD plan reviews, home dialysis coverage guidance, and enrollment help. Call 855-559-1700 for a no-cost review.",
