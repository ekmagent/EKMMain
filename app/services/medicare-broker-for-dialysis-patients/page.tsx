...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for dialysis patients — ESRD enrollment help, home dialysis coverage guidance, and free plan comparisons. Call 855-559-1700 for a no-cost review.",
