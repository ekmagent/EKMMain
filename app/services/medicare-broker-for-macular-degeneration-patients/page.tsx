...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker helping macular degeneration patients find plans covering anti-VEGF injections, OCT scans & retina specialists. Free plan match: 855-559-1700.",
