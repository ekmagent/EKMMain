...
export const metadata: Metadata = {
  ...
  description:
    "Compare Medicare Supplement Plan G costs for a 68-year-old by carrier and state. Identical coverage, different prices — call 855-559-1700 for a free rate review.",
