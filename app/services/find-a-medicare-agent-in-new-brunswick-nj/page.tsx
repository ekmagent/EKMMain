...
export const metadata: Metadata = {
  ...
  description:
    "Work with a licensed Medicare agent in New Brunswick, NJ for free, side-by-side plan comparisons. Call Anthony Orner at 855-559-1700 for clear local guidance.",
