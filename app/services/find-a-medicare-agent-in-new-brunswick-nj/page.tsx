...
export const metadata: Metadata = {
  ...
  description:
    "Find a trusted Medicare agent in New Brunswick, NJ who compares plans from every top carrier at no cost. Call Anthony Orner today for clear, licensed guidance.",
