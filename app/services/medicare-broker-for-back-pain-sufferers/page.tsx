...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for back pain sufferers — compare plans covering PT, chiropractic, injections & surgery. Free help from Anthony Orner. Call 855-559-1700.",
      ...
      <article className="max-w-3xl mx-auto">
        ...
        <section className="mt-10 mb-8">
          ...
          <ul className="space-y-2">
            ...
            <div className="text-sm text-gray-600 mt-4">For state-specific help, contact the <a href="https://www.shiphelp.org/" rel="noopener noreferrer" target="_blank" className="underline">State Health Insurance Assistance Program (SHIP)</a> for free, unbiased Medicare counseling in your state.</div>
      </section>
      </article>
    </>
  );
