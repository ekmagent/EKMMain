...
,
  {
    question: "What does a licensed Medicare insurance broker do?",
    answer:
      "A licensed Medicare broker helps you compare Medigap, Medicare Advantage, and Part D plans from multiple carriers so you can pick coverage that fits your doctors, medications, and budget. Brokers are independent and do not charge you a fee — they are compensated by the insurance carrier after you enroll. You keep the same plan benefits and pricing whether you enroll on your own or through a broker.",
  },
  {
    question: "Can I get help directly from Medicare instead of a broker?",
    answer:
      "Yes. You can call 1-800-MEDICARE (1-800-633-4227) 24/7 or live chat through Medicare.gov for general questions about benefits, enrollment, and claims. A licensed broker adds personalized plan comparisons across carriers and ongoing service during the year, which Medicare's general help line does not provide.",
  },
  {
    question: "How do I sign up for Medicare Part A and Part B?",
    answer:
...
,
  {
    question: "What does a licensed Medicare insurance broker do?",
    answer:
      "A licensed Medicare broker helps you compare Medigap, Medicare Advantage, and Part D plans from multiple carriers and enroll in the option that fits your health needs and budget. Brokers are appointed by insurance companies and licensed by each state's department of insurance. Our service is free to you — call 855-559-1700 to speak with Anthony Orner, licensed in NJ and 34 states.",
  },
  {
    question: "Is there a cost to use MedicareYourself's services?",
    answer:
      "No. Our plan reviews, comparisons, and enrollment help are completely free to you. Brokers are compensated by the insurance carriers when a client enrolls, and the commission is the same regardless of which plan you choose — so our recommendations stay unbiased.",
  },
  {
    question: "How do I get started comparing Medicare plans?",
    answer:
      "The fastest way is to call 855-559-1700 for a free, no-pressure consultation. We'll review your current coverage, doctors, prescriptions, and budget, then walk you through Medigap, Medicare Advantage, and Part D options available in your ZIP code. You can also browse our condition-specific and state-specific guides on this page.",
  }
,
  {
    question: "What does a licensed Medicare insurance broker do?",
    answer:
      "A licensed Medicare broker helps you compare Medigap, Medicare Advantage, and Part D plans from multiple insurance carriers so you can choose coverage that fits your health needs and budget. Brokers are appointed with carriers and must follow CMS marketing and enrollment rules. At MedicareYourself, Anthony Orner is licensed in NJ and 34 other states and provides free, independent guidance.",
  },
  {
    question: "Does it cost more to use a broker instead of enrolling directly?",
    answer:
      "No. Medicare plan premiums are the same whether you enroll through a licensed broker or directly with the insurance carrier. Brokers are paid a standardized commission by the carrier after you enroll, so there is no added cost to you for the help, plan comparisons, or ongoing support.",
  },
  {
    question: "Can I get help comparing plans if I live outside New Jersey?",
    answer:
      "Yes. Although our office is based in NJ, Anthony Orner is licensed in 34 additional states and can review Medigap, Medicare Advantage, and Part D options available in your ZIP code. You can also call 1-800-MEDICARE or contact your State Health Insurance Assistance Program (SHIP) for free, unbiased counseling.",
  }
,
  {
    question: "What does an independent Medicare broker actually do?",
    answer:
      "An independent Medicare broker compares plans from multiple insurance carriers to help you find coverage that fits your health needs and budget. We explain how Medigap, Medicare Advantage, and Part D work together, check that your doctors and medications are covered, and handle enrollment paperwork. There's no cost to you for using a licensed broker.",
  },
  {
    question: "Can I get help directly from Medicare instead of using a broker?",
    answer:
      "Yes. You can call 1-800-MEDICARE (1-800-633-4227) 24/7 or visit Medicare.gov to compare plans on your own. A licensed broker adds value by offering personalized plan comparisons, ongoing service, and help navigating enrollment periods. Both options are free to use.",
  },
  {
    question: "How do I know if a Medicare broker is licensed?",
    answer:
      "Every licensed broker has an NPN (National Producer Number) and a state insurance license you can verify through your state's Department of Banking and Insurance. Anthony Orner is licensed under NPN 1902584006 in New Jersey and 34 additional states. Always confirm a broker is appointed with the carriers they recommend.",
  }
,
  {
    question: "What does a licensed Medicare insurance broker do?",
    answer:
      "A licensed Medicare broker helps you compare Medigap, Medicare Advantage, and Part D plans from multiple carriers so you can choose coverage that fits your health needs and budget. Brokers are appointed with insurance companies and licensed by state departments of insurance. At MedicareYourself, our help is free to you — call 855-559-1700 to speak with Anthony Orner.",
  },
  {
    question: "Is there a cost to work with MedicareYourself?",
    answer:
      "No. There is no fee to compare plans or enroll through a licensed independent Medicare broker. Insurance carriers compensate brokers directly, and your premium is the same whether you enroll through us, the carrier, or on your own.",
  },
  {
    question: "Can I get help if I live outside New Jersey?",
    answer:
      "Yes. Anthony Orner is licensed in New Jersey and 34 additional states, so we can review plans and enroll eligible beneficiaries across most of the country. You can also reach 1-800-MEDICARE 24/7 for general questions, or contact your State Health Insurance Assistance Program (SHIP) for free local counseling.",
  }
,
  {
    question: "What does an independent Medicare broker do?",
    answer:
      "An independent Medicare broker is a licensed agent appointed with multiple insurance carriers who helps you compare Medigap, Medicare Advantage, and Part D plans side by side. There is no cost to you for working with a broker — carriers pay a standardized commission regardless of which plan you choose. This means you get unbiased guidance and ongoing support during enrollment and beyond.",
  },
  {
    question: "Can I get Medicare help directly from the government?",
    answer:
      "Yes. You can call 1-800-MEDICARE (1-800-633-4227) 24 hours a day, 7 days a week, or use the live chat at Medicare.gov. For enrollment in Part A and Part B, you'll work with the Social Security Administration. A licensed broker like Anthony Orner can complement these resources by comparing private plan options side by side.",
  },
  {
    question: "How do I know which Medicare service is right for me?",
    answer:
      "The right path depends on your health conditions, prescriptions, preferred doctors, and budget. If you have specific conditions or live in New Jersey, our condition-specific and local guides walk through how plans typically handle each situation. For personalized help, call 855-559-1700 to speak with a licensed broker.",
  }
,
  {
    question: "What does a licensed Medicare broker actually do?",
    answer:
      "A licensed Medicare broker helps you compare Medigap, Medicare Advantage, and Part D plans from multiple carriers so you can choose what fits your health needs and budget. Brokers are appointed with several insurance companies and provide unbiased plan reviews at no cost to you. You can also call 1-800-MEDICARE or visit Medicare.gov for general program questions.",
  },
  {
    question: "Is there a fee to work with MedicareYourself?",
    answer:
      "No. Our services are free to consumers because licensed brokers are compensated directly by the insurance carriers when a plan is issued. Your premium is the same whether you enroll through a broker or directly with the carrier. Call 855-559-1700 to schedule a free plan review.",
  },
  {
    question: "Can I get help comparing plans outside of New Jersey?",
    answer:
...
,
  {
    question: "What does a licensed independent Medicare broker actually do?",
    answer:
      "A licensed independent broker like Anthony Orner compares Medigap, Medicare Advantage, and Part D plans from multiple carriers to help you find coverage that fits your doctors, prescriptions, and budget. There's no cost to you for the broker's help — carriers pay the commission directly. You can also call 1-800-MEDICARE or visit Medicare.gov for official federal guidance.",
  },
  {
    question: "How do I decide between Medigap and Medicare Advantage?",
    answer:
      "Medigap (Medicare Supplement) works alongside Original Medicare and typically offers broader provider access with predictable out-of-pocket costs, while Medicare Advantage bundles Parts A, B, and usually D into one plan with network rules. The right choice depends on your providers, prescriptions, travel needs, and budget. A licensed broker can walk you through both options at 855-559-1700.",
  },
  {
    question: "Is there a fee to use MedicareYourself's services?",
    answer:
...
,
  {
    question: "What does an independent Medicare broker do?",
    answer:
      "An independent Medicare broker is licensed with multiple insurance carriers and helps you compare Medigap, Medicare Advantage, and Part D plans side by side. Because brokers are paid by the carriers, our help is free to you. Anthony Orner is licensed in NJ and 34 additional states and can review options based on your doctors, medications, and budget.",
  },
  {
    question: "Is there a cost to use MedicareYourself for plan comparisons?",
    answer:
      "No. There is no fee to speak with our licensed broker or to enroll through us. Medicare insurance carriers pay brokers a standardized commission set by CMS, so your premium is the same whether you enroll on your own or with our help. Call 855-559-1700 to get started.",
  },
  {
    question: "Can I get official Medicare help outside of a broker?",
    answer:
...
,
  {
    question: "What does a licensed Medicare broker do?",
    answer:
      "A licensed Medicare broker helps you compare Medigap, Medicare Advantage, and Part D plans from multiple carriers and enroll in the option that fits your health and budget. Independent brokers like Anthony Orner are appointed with several insurers, so recommendations are not tied to a single company. There is no cost to you for using a broker — carriers pay the broker directly. Call 855-559-1700 for free, unbiased help.",
  },
  {
    question: "Can I get help directly from Medicare instead of using a broker?",
    answer:
      "Yes. You can call 1-800-MEDICARE (1-800-633-4227) 24/7 or use the live chat at Medicare.gov for official questions about coverage, eligibility, and enrollment. However, Medicare representatives cannot recommend or enroll you in a specific private Medigap, Advantage, or Part D plan. A licensed broker can compare specific plans side-by-side and handle enrollment for you.",
  },
  {
    question: "Do you help with Medicare outside of New Jersey?",
    answer:
      ...
      <section className="bg-blue-700 text-white py-10 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-blue-200 text-sm mt-4">
            ...
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can also get free, unbiased counseling from <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ SHIP (State Health Insurance Assistance Program)</a>.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can also contact the <a href="https://www.state.nj.us/dobi/division_insurance/ship/index.htm" rel="noopener noreferrer" target="_blank">NJ State Health Insurance Assistance Program (SHIP)</a> for free, unbiased Medicare counseling.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey residents: get free counseling from the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank">NJ State Health Insurance Assistance Program (SHIP)</a>.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can also contact <a href="https://www.state.nj.us/dobi/index.shtml" rel="noopener noreferrer" target="_blank" className="underline">NJ Department of Banking &amp; Insurance</a> or the free <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ SHIP counseling program</a>.</div>
