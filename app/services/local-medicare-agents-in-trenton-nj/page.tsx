...
export const metadata: Metadata = {
  ...
  description:
    "Talk to a local Medicare agent in Trenton, NJ. Compare every major carrier at no cost with licensed broker Anthony Orner. Call 855-559-1700 for free help.",
...
export default function LocalMedicareAgentsTrentonNJ() {
  return (
    <>
      ...
      <LocalServiceSchema citySlug="trenton" />
      ...
      <article className="max-w-3xl mx-auto">
        ...
        <section className="mt-10 mb-8">
          ...
          <ul className="space-y-2">
            ...
            <div className="text-sm text-gray-600 mt-2">New Jersey seniors can also contact <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ SHIP (State Health Insurance Assistance Program)</a> for free unbiased Medicare counseling.</div>
      </section>
      </article>
    </>
  );
