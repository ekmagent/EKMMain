...
export const metadata: Metadata = {
  ...
  description:
    "Wondering when you can switch Medicare Supplement plans? Learn your Medigap rights, open enrollment, and guaranteed issue windows. Call 855-559-1700 for free help.",
