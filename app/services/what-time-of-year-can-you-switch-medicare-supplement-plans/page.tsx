...
export const metadata: Metadata = {
  ...
  description:
    "Wondering when you can switch Medicare Supplement plans? Learn Medigap open enrollment, guaranteed issue rights & underwriting. Free broker help — 855-559-1700.",
