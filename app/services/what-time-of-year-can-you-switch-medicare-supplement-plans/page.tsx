...
export const metadata: Metadata = {
  ...
  description:
    "Switch Medicare Supplement plans the right way. Learn Medigap Open Enrollment, guaranteed issue rights, and underwriting. Free broker help — call 855-559-1700.",
