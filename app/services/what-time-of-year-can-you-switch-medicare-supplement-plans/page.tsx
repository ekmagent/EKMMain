...
export const metadata: Metadata = {
  ...
  description:
    "When can you switch Medicare Supplement plans? Learn Medigap windows, guaranteed issue rights, and underwriting. Free help from a licensed broker — 855-559-1700.",
