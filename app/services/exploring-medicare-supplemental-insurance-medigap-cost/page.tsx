...
export const metadata: Metadata = {
  ...
  description:
    "Compare Medigap costs by plan letter, pricing model, and ZIP code. Get a free rate review from a licensed broker — call 855-559-1700 to find your lowest premium.",
