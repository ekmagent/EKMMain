...
export const metadata: Metadata = {
  ...
  description:
    "Compare Medigap costs by plan letter, pricing model, and ZIP. A free broker rate review may lower your premium — call 855-559-1700 for an honest quote today.",
