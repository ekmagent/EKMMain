...
export const metadata: Metadata = {
  ...
  description:
    "Comparing Medigap costs? See what drives premiums by plan letter, pricing model, and state — then compare carriers free with a licensed broker. Call 855-559-1700.",
