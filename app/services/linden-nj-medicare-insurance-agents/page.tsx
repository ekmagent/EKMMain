...
export const metadata: Metadata = {
  ...
  description:
    "Linden NJ Medicare insurance agents — Anthony Orner, independent broker, compares Supplement & Advantage plans across top carriers. Call 855-559-1700 for a free quote.",
