...
export const metadata: Metadata = {
  ...
  description:
    "Linden NJ Medicare agent Anthony Orner compares Supplement & Advantage plans across top carriers in Union County. Call 855-559-1700 for a free quote today.",
