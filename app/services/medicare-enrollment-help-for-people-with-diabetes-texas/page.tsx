...
export const metadata: Metadata = {
  ...
  description:
    "Texas Medicare help for diabetes — compare plans covering insulin, CGMs & test supplies. Call 855-559-1700 for free licensed broker guidance at no cost to you.",
