...
export const metadata: Metadata = {
  ...
  description:
    "Have a pre-existing condition? You can still get a Medicare Supplement plan during Medigap Open Enrollment—no underwriting. Call 855-559-1700 for free help.",
