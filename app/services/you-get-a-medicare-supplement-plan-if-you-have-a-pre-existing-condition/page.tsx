...
export const metadata: Metadata = {
  ...
  description:
    "Yes, you can get a Medicare Supplement plan with a pre-existing condition during Medigap Open Enrollment. Know your rights—call 855-559-1700 for free guidance.",
