...
export const metadata: Metadata = {
  ...
  description:
    "Yes—get a Medicare Supplement plan with a pre-existing condition during Medigap Open Enrollment. No underwriting, no denials. Call 855-559-1700 for free help.",
