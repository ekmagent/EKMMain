...
export const metadata: Metadata = {
  ...
  description:
    "Yes — you can get a Medicare Supplement plan with pre-existing conditions. Learn guaranteed-issue windows and state rules. Call 855-559-1700 for free guidance.",
