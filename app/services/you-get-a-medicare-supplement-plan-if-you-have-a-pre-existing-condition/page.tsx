...
export const metadata: Metadata = {
  ...
  description:
    "Yes, you can get a Medicare Supplement plan with a pre-existing condition during Medigap Open Enrollment—no underwriting. Call 855-559-1700 for free guidance.",
