...
export const metadata: Metadata = {
  ...
  description:
    "CLL Medicare broker help: protect oncologist access, time Medigap enrollment right, and cover oral targeted therapies. Free consult — call 855-559-1700.",
...
,
  {
    question: "Will Medicare cover clinical trials for CLL?",
    answer:
      "Yes. Medicare covers routine costs associated with qualifying clinical trials, including doctor visits, lab work, and standard care you would receive outside the trial. This is especially important for CLL patients, since many newer targeted therapies and CAR-T approaches are studied in trials. Call 855-559-1700 if you want help confirming coverage before enrolling.",
  },
  {
    question: "Does Part D cover oral CLL medications like BTK inhibitors?",
    answer:
      "Yes. Oral targeted therapies such as BTK inhibitors and BCL-2 inhibitors are typically covered under Medicare Part D rather than Part B. Coverage, tier placement, and prior authorization requirements vary by plan, so reviewing each plan's formulary against your prescribed regimen is essential before enrolling.",
  },
  {
    question: "Can I switch from Medicare Advantage to Original Medicare after a CLL diagnosis?",
    answer:
...
,
  {
    question: "Does Medicare Part D cover oral BTK inhibitors for CLL?",
    answer:
      "Yes. Oral targeted therapies such as BTK inhibitors and BCL-2 inhibitors are typically covered under Medicare Part D as specialty-tier drugs. Costs vary by plan formulary, and the new Part D out-of-pocket cap helps protect CLL patients from catastrophic drug spending. We can review formularies side by side to find the plan that best covers your specific regimen.",
  },
  {
    question: "Can I switch from Medicare Advantage to Original Medicare after a CLL diagnosis?",
    answer:
      "You can switch back to Original Medicare during the Annual Enrollment Period or the Medicare Advantage Open Enrollment Period. However, qualifying for a Medigap plan after the switch usually requires medical underwriting, and a CLL diagnosis may lead to denial outside of guaranteed issue situations. Call 855-559-1700 before making any changes so we can map out your options.",
  },
  {
    question: "Does Medicare cover clinical trials for CLL?",
    answer:
...
,
  {
    question: "Are clinical trials for CLL covered by Medicare?",
    answer:
      "Medicare covers routine patient care costs in qualifying clinical trials, including doctor visits, lab work, and hospital stays related to the trial. The trial sponsor typically covers the investigational drug itself. This can be important for CLL patients exploring newer targeted therapies or CAR-T options not yet approved as standard care.",
  }
,
  {
    question: "Does Medicare cover clinical trials for CLL?",
    answer:
      "Yes. Medicare covers routine costs of qualifying clinical trials, including those for CLL treatments like targeted therapies and CAR-T research. This includes doctor visits, lab work, and hospital stays related to the trial. The investigational drug or device itself is typically covered by the trial sponsor.",
  },
  {
    question: "What should CLL patients look for in a Part D plan?",
    answer:
      "CLL patients taking oral targeted therapies like BTK or BCL-2 inhibitors should verify that their specific medication is on the plan's formulary and check the tier placement. Look at the plan's specialty tier coinsurance, prior authorization requirements, and preferred pharmacy network. We can run a personalized Part D comparison for your medications — call 855-559-1700.",
  },
  {
    question: "Can I switch from Medicare Advantage back to Original Medicare after a CLL diagnosis?",
    answer:
      "You can switch back to Original Medicare during the Annual Enrollment Period or the Medicare Advantage Open Enrollment Period. However, getting a Medigap plan afterward may require medical underwriting in most states, and a CLL diagnosis could lead to denial. Trial right protections may apply in limited situations.",
  }
,
  {
    question: "Are CLL clinical trials covered by Medicare?",
    answer:
      "Medicare covers routine costs of qualifying clinical trials, including office visits, lab work, and standard care you would receive even outside the trial. The investigational drug itself is usually provided by the trial sponsor. If you're considering a CLL trial at a major cancer center, call 855-559-1700 to review how your current plan handles trial-related costs.",
  }
,
  {
    question: "Will Medicare cover a second opinion from a CLL specialist?",
