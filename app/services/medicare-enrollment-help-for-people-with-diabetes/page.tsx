...
,
  {
    question: "Does Medicare Part D cover insulin?",
    answer:
      "Yes. Medicare Part D plans cover insulin, and thanks to recent changes under the Inflation Reduction Act, out-of-pocket costs for a month's supply of covered insulin are capped. Insulin used with a traditional pump is covered under Part B as durable medical equipment. Call 855-559-1700 to compare Part D formularies for your specific insulin.",
  },
  {
    question: "Are diabetes test strips and lancets covered by Medicare?",
    answer:
      "Yes. Medicare Part B covers blood sugar monitors, test strips, lancets, and control solution as durable medical equipment when prescribed by your doctor. You'll need to use a Medicare-enrolled DME supplier. The quantity covered depends on whether you use insulin, so ask your provider to document your testing frequency.",
  },
  {
    question: "Does Medicare cover diabetes self-management training?",
    answer:
...
,
  {
    question: "Does Medicare Part D cover insulin?",
    answer:
      "Yes. Medicare Part D covers insulin taken by injection or pen, and under the Inflation Reduction Act your monthly copay for a covered insulin is capped. Insulin used with a traditional insulin pump is covered under Part B instead. Call 855-559-1700 to make sure your specific insulin is on your plan's formulary before you enroll.",
  },
  {
    question: "Are diabetes test strips and lancets covered by Medicare?",
    answer:
      "Yes. Medicare Part B covers blood glucose monitors, test strips, lancets, and control solutions as durable medical equipment when prescribed by your doctor. The quantity covered depends on whether you use insulin. You'll need to use a Medicare-approved supplier to get the lowest out-of-pocket cost.",
  },
  {
    question: "Can I switch Medicare plans if my diabetes medications change?",
    answer:
...
,
  {
    question: "Does Medicare Part D cap what I pay for insulin?",
    answer:
      "Yes. Under the Inflation Reduction Act, Medicare Part D plans cap the monthly copay for a covered insulin product, and there is no deductible applied to insulin. This applies to insulins on your plan's formulary, so it's important to confirm your specific insulin is covered before enrolling. Call 855-559-1700 to review Part D plans that cover your insulin.",
  },
  {
    question: "Are diabetic test strips and lancets covered by Medicare?",
    answer:
      "Yes. Medicare Part B covers blood sugar monitors, test strips, lancets, and control solutions as durable medical equipment when prescribed by your doctor. You'll need to use a Medicare-enrolled supplier, and the quantity covered depends on whether you use insulin. Mail-order suppliers must be part of the Medicare National Mail-Order Program for diabetic supplies.",
  },
  {
    question: "Does Medicare cover diabetes self-management training?",
    answer:
