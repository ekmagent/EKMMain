...
export const metadata: Metadata = {
  ...
  description:
    "Medicare insurance agents in Burlington, NJ — Anthony Orner, licensed independent broker, compares Medigap, Advantage & Part D plans. Free consultation: call 855-559-1700.",
