...
export const metadata: Metadata = {
  ...
  description:
    "Compare Medigap, Medicare Advantage & Part D plans with a licensed independent broker serving Burlington County, NJ. Free, no-obligation help — call 855-559-1700.",
