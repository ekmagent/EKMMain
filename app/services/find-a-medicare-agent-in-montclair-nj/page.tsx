...
export const metadata: Metadata = {
  ...
  description:
    "Find a Medicare agent in Montclair NJ — Anthony Orner, licensed independent broker, compares top carriers across Essex County. Free consultation, call 855-559-1700.",
