...
export const metadata: Metadata = {
  ...
  description:
    "Medigap premiums rising in 2025? Compare carriers offering identical standardized benefits and see if switching can lower your rate. Free review: 855-559-1700.",
