...
export const metadata: Metadata = {
  ...
  description:
    "Medigap premiums climbing in 2025? Compare carriers offering identical standardized benefits and see if switching lowers your rate. Free review: 855-559-1700.",
