...
export const metadata: Metadata = {
  ...
  description:
    "Medigap premiums climbing in 2025? Compare carriers with identical standardized benefits and see if switching lowers your rate. Free review: 855-559-1700.",
