...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for diabetics — Anthony Orner compares plans for insulin, CGMs, and specialist coverage. Free expert help finding your fit. Call 855-559-1700.",
