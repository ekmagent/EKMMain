...
export const metadata: Metadata = {
  ...
  description:
    "Compare Plan G rates for a 68-year-old in New Jersey across top carriers — same coverage, different premiums. Call 855-559-1700 for a free side-by-side quote.",
