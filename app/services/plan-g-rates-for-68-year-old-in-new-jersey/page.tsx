...
export const metadata: Metadata = {
  ...
  description:
    "Compare Plan G rates for a 68-year-old in NJ across top carriers. Same coverage, different premiums — call 855-559-1700 for a free side-by-side comparison.",
