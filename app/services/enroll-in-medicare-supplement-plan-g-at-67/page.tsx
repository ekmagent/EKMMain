...
export const metadata: Metadata = {
  ...
  description:
    "Enrolling in Medicare Supplement Plan G at 67? Learn about underwriting, guaranteed issue rights, and locking in a fair rate. Call 855-559-1700 for a free quote.",
