...
export const metadata: Metadata = {
  ...
  description:
    "Medicare Supplement approval typically takes 1–3 weeks. Learn what affects your timeline and how to speed up approval — call 855-559-1700 for a free review.",
