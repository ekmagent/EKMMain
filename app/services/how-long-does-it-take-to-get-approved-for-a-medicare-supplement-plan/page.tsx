...
export const metadata: Metadata = {
  ...
  description:
    "How long does Medigap approval take? Most applications clear in 1–3 weeks, with guaranteed approval during open enrollment. Call 855-559-1700 for help today.",
