...
export const metadata: Metadata = {
  ...
  description:
    "Compare Medicare Supplement Plan G and Plan N monthly premiums across top carriers and lock in the lowest rate. Call 855-559-1700 for a free, no-obligation quote.",
