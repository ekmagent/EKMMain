...
export const metadata: Metadata = {
  ...
  description:
    "Compare Medicare Supplement Plan G and Plan N monthly premiums by carrier, age, and ZIP code. Get a free, no-obligation quote — call 855-559-1700.",
...
,
  {
    question: "Does where I live affect how much I pay for a Medigap plan?",
    answer:
      "Yes. Medigap premiums vary widely by ZIP code because insurance companies base rates on local claims history, competition, and state regulations. Two people the same age with the same plan letter can pay very different premiums depending on where they live. Call 855-559-1700 for a ZIP-specific quote.",
  }
,
  {
    question: "How do insurance companies decide what to charge for the same Medigap plan letter?",
    answer:
      "Medicare.gov explains that carriers use one of three pricing methods: community-rated (same price regardless of age), issue-age-rated (based on the age you buy), or attained-age-rated (increases as you get older). The benefits inside each lettered plan are identical by law, so price is the main differentiator. Comparing several carriers side by side is the only reliable way to find the lowest rate for your situation.",
  }
];
      ...
      <section className="mt-12">
        ...
        <ul className="space-y-2">
          ...
          <li>
            ...
            <div className="text-sm text-gray-600 mt-4">For state-specific guidance, visit the <a href="https://www.state.nj.us/dobi/division_insurance/index.htm" rel="noopener noreferrer" target="_blank" className="text-blue-600 underline">NJ Department of Banking and Insurance</a> or contact your local <a href="https://www.shiphelp.org/" rel="noopener noreferrer" target="_blank" className="text-blue-600 underline">State Health Insurance Assistance Program (SHIP)</a> for free counseling.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can get free, unbiased counseling through <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="text-blue-600 underline">NJ SHIP (State Health Insurance Assistance Program)</a> or contact the <a href="https://www.nj.gov/dobi/" rel="noopener noreferrer" target="_blank" className="text-blue-600 underline">NJ Department of Banking and Insurance</a>.</div>
      </section>
    </main>
  );
