...
export const metadata: Metadata = {
  ...
  description:
    "Compare Medicare Supplement Plan G and Plan N monthly premiums and see how carrier pricing methods affect your cost. Get a free personalized quote today.",
