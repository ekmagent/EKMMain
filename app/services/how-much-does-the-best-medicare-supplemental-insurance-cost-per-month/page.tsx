...
export const metadata: Metadata = {
  ...
  description:
    "How much does the best Medicare Supplement plan cost per month? Compare Plan G and Plan N pricing methods by carrier. Call 855-559-1700 for a free quote.",
