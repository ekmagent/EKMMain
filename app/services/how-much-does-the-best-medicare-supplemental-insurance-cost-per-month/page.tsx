...
export const metadata: Metadata = {
  ...
  description:
    "Compare Medicare Supplement Plan G and Plan N monthly premiums and learn how carriers price policies differently. Get your free personalized quote today.",
