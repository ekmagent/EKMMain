...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for arthritis sufferers — compare plans covering biologics, rheumatologists, and joint care. Free help from a licensed broker. Call 855-559-1700.",
