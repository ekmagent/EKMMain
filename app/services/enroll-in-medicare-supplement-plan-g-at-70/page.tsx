...
export const metadata: Metadata = {
  ...
  description:
    "Enroll in Medicare Supplement Plan G at 70 with free broker help. Compare top carriers, navigate underwriting, and lock in stable rates. Call 855-559-1700.",
