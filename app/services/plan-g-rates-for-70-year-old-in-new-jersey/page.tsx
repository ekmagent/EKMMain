      ...
      <article className="max-w-3xl mx-auto px-4">
        ...
        <section className="mt-12">
          ...
          <ul className="space-y-2">
            ...
            <div className="text-sm text-gray-600 mt-4">For New Jersey-specific guidance, contact the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a> for free unbiased Medicare counseling.</div>
      </section>
      </article>
    </>
  );
