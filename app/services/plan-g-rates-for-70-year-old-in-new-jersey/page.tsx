...
export const metadata: Metadata = {
  ...
  description:
    "Compare Plan G rates for a 70-year-old in New Jersey with a licensed local broker. See how NJ community-rated Medigap pricing works. Call 855-559-1700 today.",
