...
,
  {
    question: "Why do Plan G premiums vary so much between carriers in New Jersey?",
    answer:
      "Every Medigap Plan G covers the exact same federally standardized benefits, so the only real difference between carriers is price and company stability. Insurers set their own rates based on their claims experience, marketing costs, and discounts they offer. That's why comparing several NJ carriers side by side is the single biggest factor in saving money.",
  },
  {
    question: "Is Plan G a good choice for a 70-year-old in NJ?",
    answer:
      "Plan G is the most comprehensive Medigap plan available to people who became Medicare-eligible after January 1, 2020. It covers nearly all out-of-pocket costs after you meet the annual Part B deductible, which makes budgeting predictable. For most 70-year-olds in New Jersey, the tradeoff between premium and low cost-sharing makes Plan G a strong fit.",
  },
  {
    question: "Do I need to answer health questions to get Plan G at age 70?",
    answer:
      "If you are outside your 6-month Medigap Open Enrollment Period and don't qualify for a guaranteed issue right, most NJ carriers will require medical underwriting to switch into Plan G. Approval and pricing can depend on your health history. A licensed broker can pre-screen you with multiple carriers before you formally apply.",
  }
,
  {
    question: "What does Medigap Plan G cover in New Jersey?",
    answer:
      "Plan G covers your Part A hospital coinsurance and deductible, Part B coinsurance, the first three pints of blood, skilled nursing facility coinsurance, hospice coinsurance, and Part B excess charges. It also includes limited foreign travel emergency coverage. The only major out-of-pocket cost you pay before coverage kicks in is the annual Part B deductible.",
  },
  {
    question: "Is Medigap Plan G the same across all carriers in New Jersey?",
    answer:
      "Yes. Medigap benefits are standardized by federal law, so Plan G from one carrier provides the exact same coverage as Plan G from another. The only differences between carriers are price, customer service, and financial stability — which is why comparing rates side by side matters so much.",
  }
,
  {
    question: "Why do Plan G premiums vary so much between carriers in New Jersey?",
...
,
  {
    question: "Why do Plan G premiums vary so much between carriers in New Jersey?",
    answer:
      "Every Medigap Plan G offers the same federally standardized benefits, so the only real difference between carriers is price and customer service. Insurance companies set their own premiums based on claims experience, overhead, and underwriting practices. That's why comparing multiple NJ carriers side by side is the single most important step.",
  },
  {
    question: "Is Plan G worth it for a 70-year-old in New Jersey?",
    answer:
...
,
  {
    question: "What does Plan G cover for a 70-year-old in New Jersey?",
    answer:
      "Medigap Plan G covers the Part A hospital coinsurance and deductible, Part B coinsurance, the first three pints of blood, skilled nursing facility coinsurance, hospice coinsurance, and Part B excess charges. It also includes limited foreign travel emergency coverage. The only major cost-sharing item Plan G does not cover is the annual Part B deductible.",
  },
  {
    question: "Are Plan G benefits the same across every NJ carrier?",
    answer:
      "Yes. Medigap plan benefits are standardized by federal law, so Plan G from any carrier in New Jersey provides identical coverage. The only difference between carriers is the monthly premium and customer service experience, which is why comparing multiple companies matters.",
  },
  {
    question: "Should I work with a broker to shop Plan G rates in NJ?",
    answer:
      ...
      <article className="max-w-3xl mx-auto px-4">
        ...
        <section className="mt-12">
          ...
          <ul className="space-y-2">
            ...
            <div className="text-sm text-gray-600 mt-4">New Jersey help: <a href="https://www.nj.gov/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a> for free, unbiased Medicare counseling.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey help: <a href="https://www.state.nj.us/dobi/division_insurance/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a> offers free, unbiased Medicare counseling.</div>
            <div className="text-sm text-gray-600 mt-4">For unbiased local help, contact the <a href="https://www.state.nj.us/dobi/division_insurance/index.htm" rel="noopener noreferrer" target="_blank" className="underline">New Jersey Department of Banking and Insurance</a> or the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a>.</div>
            ...
            <div className="text-sm text-gray-600 mt-4">For free, unbiased Medicare counseling in New Jersey, visit the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a>.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey help: <a href="https://www.state.nj.us/dobi/division_insurance/index.htm" rel="noopener noreferrer" target="_blank" className="underline">NJ Department of Banking and Insurance</a> and the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a>.</div>
            ...
            <div className="text-sm text-gray-600 mt-4">New Jersey resource: <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="text-blue-600 underline">NJ State Health Insurance Assistance Program (SHIP)</a> offers free Medicare counseling.</div>
            ...
            <p className="text-sm text-gray-600 mt-2">New Jersey residents can also contact <a href="https://www.state.nj.us/dobi/index.shtml" rel="noopener noreferrer" target="_blank" className="underline">NJ Department of Banking and Insurance</a> or the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ SHIP program</a> for free counseling.</p>
            <div className="text-sm text-gray-600 mt-4">For state-specific help, contact the <a href="https://www.state.nj.us/dobi/index.html" rel="noopener noreferrer" target="_blank" className="underline">New Jersey Department of Banking and Insurance</a> or the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a>.</div>
            ...
            <div className="text-sm text-gray-600 mt-4">New Jersey help: <a href="https://www.state.nj.us/dobi/division_insurance/ship/shipindex.htm" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a></div>
            <div className="text-sm text-gray-600 mt-4">For unbiased NJ counseling, contact the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">New Jersey State Health Insurance Assistance Program (SHIP)</a> or the <a href="https://www.nj.gov/dobi/" rel="noopener noreferrer" target="_blank" className="underline">NJ Department of Banking and Insurance</a>.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can also contact <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ SHIP (State Health Insurance Assistance Program)</a> for free, unbiased Medicare counseling.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can also contact <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ SHIP (State Health Insurance Assistance Program)</a> for free, unbiased Medicare counseling.</div>
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can also contact the <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a> for free, unbiased Medicare counseling.</div>
