...
export const metadata: Metadata = {
  ...
  description:
    "Compare Plan G rates for a 70-year-old in NJ with a licensed local broker. Understand community-rated Medigap pricing and call 855-559-1700 for free quotes.",
