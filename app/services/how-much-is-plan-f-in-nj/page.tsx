...
export const metadata: Metadata = {
  ...
  description:
    "How much is Plan F in NJ in 2026? Compare premiums by age, see why rates keep rising, and find out if Plan G saves more. Call 855-559-1700 for a free quote.",
