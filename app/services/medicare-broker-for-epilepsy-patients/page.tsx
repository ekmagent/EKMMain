...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for epilepsy patients in NJ. Anthony Orner compares Part D formularies so seizure meds stay covered. Call 855-559-1700 for a free quote.",
      ...
      <section className="mt-12">
        ...
        <ul className="space-y-2">
          ...
          <li>
            ...
            <div className="text-sm text-gray-600 mt-4">NJ residents can also get free counseling from <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ SHIP (State Health Insurance Assistance Program)</a>.</div>
