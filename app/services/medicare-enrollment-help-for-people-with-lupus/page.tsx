...
export const metadata: Metadata = {
  ...
  description:
    "Medicare enrollment help for lupus patients in NJ. Protect rheumatology, biologics & infusion coverage. Call 855-559-1700 for free licensed broker guidance.",
