...
export const metadata: Metadata = {
  ...
  description:
    "Medicare enrollment help for lupus patients in NJ. Keep your rheumatologist, biologics & infusions covered. Call 855-559-1700 for free broker guidance today.",
