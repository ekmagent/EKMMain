...
export const metadata: Metadata = {
  ...
  description:
    "Medicare enrollment help for lupus patients in NJ. Protect rheumatologist access, biologics & infusions with the right plan. Free guidance — call 855-559-1700.",
