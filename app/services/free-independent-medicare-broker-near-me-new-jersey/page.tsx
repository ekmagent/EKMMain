...
export const metadata: Metadata = {
  ...
  description:
    "Compare Medigap and Medicare Advantage plans in NJ with independent broker Anthony Orner — free, no-pressure help from multiple carriers. Call 855-559-1700.",
