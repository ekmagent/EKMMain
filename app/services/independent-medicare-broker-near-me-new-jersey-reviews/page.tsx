...
export const metadata: Metadata = {
  ...
  description:
    "Read real New Jersey client reviews of independent Medicare broker Anthony Orner. Free multi-carrier plan comparisons — call 855-559-1700 for a no-cost consultation.",
