...
export const metadata: Metadata = {
  ...
  description:
    "Work with an independent Medicare Supplement agent near you in NJ. Anthony Orner compares Medigap Plan G & N rates across top carriers free. Call 855-559-1700.",
      ...
      <article className="max-w-3xl mx-auto px-4 py-8">
        ...
        <section className="mt-12">
          ...
          <ul className="space-y-2">
            ...
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can also contact <a href="https://www.state.nj.us/dobi/division_insurance/ship/" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a> for free, unbiased Medicare counseling.</div>
