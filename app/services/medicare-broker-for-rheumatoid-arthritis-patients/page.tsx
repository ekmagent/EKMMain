...
export const metadata: Metadata = {
  ...
  description:
    "Medicare broker for rheumatoid arthritis patients — compare plans covering biologics, infusions & rheumatologists. Free plan review. Call 855-559-1700 today.",
      ...
      <section className="mt-12">
        ...
        <ul className="space-y-2">
          ...
          <li>
            ...
            <div className="text-sm text-gray-600 mt-4">For unbiased local counseling, contact <a href="https://www.state.nj.us/humanservices/doas/services/ship/" rel="noopener noreferrer" target="_blank" className="underline">New Jersey SHIP (State Health Insurance Assistance Program)</a>.</div>
      </section>
    </main>
  );
}