...
export const metadata: Metadata = {
  ...
  description:
    "Switch Medigap Plan G carriers and keep identical federal benefits at a lower premium. Free carrier comparison — call 855-559-1700 to see if you qualify today.",
...
,
  {
    question: "Do I have to answer health questions when switching Medigap carriers?",
    answer:
      "In most states, yes — outside of your initial 6-month Medigap Open Enrollment Period or a guaranteed issue situation, carriers can use medical underwriting and may decline you based on health history. Common conditions like controlled high blood pressure or cholesterol usually do not disqualify you, but recent cancer treatment, COPD, or insulin-dependent diabetes can. A broker can pre-screen you with multiple carriers before you formally apply so you do not risk a denial on your record.",
  },
  {
    question: "Will my new Medigap policy have a waiting period for pre-existing conditions?",
    answer:
      "If you have had continuous creditable coverage (such as your current Medigap plan or other qualifying insurance) for at least 6 months, the new carrier generally cannot impose a pre-existing condition waiting period. This is true for both guaranteed issue situations and underwritten applications. Always keep your new policy active for at least 30 days before canceling the old one to avoid any gap in coverage.",
  },
  {
    question: "Does switching Medigap carriers affect my prescription drug plan?",
    answer:
...
,
  {
    question: "Do I have a federal right to switch Medigap policies anytime?",
    answer:
      "In most cases, no. Under federal law, you only have a guaranteed right to switch Medigap policies during your 6-month Medigap Open Enrollment Period or if you qualify for a specific guaranteed issue right. Outside of those windows, carriers can use medical underwriting and may deny your application. Some states offer broader switching rights than federal law — your state insurance department can confirm what applies in your area.",
  }
,
  {
    question: "What happens during the 30-day Medigap free look period?",
    answer:
      "When you switch Medigap policies, you get a 30-day free look period to try the new policy. You'll need to keep paying premiums on both your old and new policy for one month. After 30 days, if you're satisfied with the new plan, you can cancel the old one and only pay the new premium going forward.",
  }
,
  {
    question: "Do I have a federal right to switch Medigap policies outside Open Enrollment?",
    answer:
      "In most cases, no. Federal law only guarantees your right to switch Medigap policies during your 6-month Medigap Open Enrollment Period or when you qualify for a specific guaranteed issue right. Outside those windows, carriers in most states can use medical underwriting. Some states offer additional switching rights beyond federal law, so it's worth checking with your state insurance department or a licensed broker.",
  }
,
  {
    question: "Do I have to go through medical underwriting to switch Medigap carriers?",
    answer:
...
,
  {
    question: "Will I have to answer health questions when I switch Medigap carriers?",
    answer:
      "In most cases, yes. Under federal law you generally do not have the right to switch Medigap policies outside your 6-month Medigap Open Enrollment Period unless you qualify for a guaranteed issue right. Outside those windows, carriers can use medical underwriting and may decline coverage based on health. Some states offer broader switching rights, so it is worth checking with your state insurance department or a licensed broker.",
  }
,
  {
    question: "Will I have to answer health questions to switch Medicare Supplement carriers?",
    answer:
...
,
  {
    question: "Do I have to answer health questions to switch Medigap carriers?",
    answer:
      "In most states, yes — if you are outside your 6-month Medigap Open Enrollment Period and do not have a Guaranteed Issue right, carriers can require medical underwriting. That means they can ask about your health history and prescriptions, and they can decline your application. A broker can pre-screen you against each carrier's underwriting guidelines before you submit a formal application.",
  },
  {
    question: "Will my new Medigap plan start automatically when I cancel the old one?",
    answer:
      "No — you should never cancel your existing Medigap policy until the new carrier has approved your application and given you a confirmed effective date. Best practice is to set the new plan to start on the first of a month, then submit a cancellation request to the old carrier for the same date. This prevents any gap in supplemental coverage.",
  },
  {
    question: "Does switching Medigap carriers restart a waiting period for pre-existing conditions?",
    answer:
      "If you have had continuous Medigap coverage, most carriers waive any pre-existing condition waiting period when you switch. Federal law protects continuous coverage in Guaranteed Issue situations, and many carriers voluntarily waive the waiting period during standard underwritten switches as well. Confirm this with the specific carrier before you apply.",
  }
];
      ...
      <section className="bg-gray-50 border-t py-8 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            ...
            <div className="text-sm text-gray-600 mt-4">New Jersey residents can contact the <a href="https://www.state.nj.us/dobi/division_insurance/ship/shipindex.htm" rel="noopener noreferrer" target="_blank" className="underline">NJ State Health Insurance Assistance Program (SHIP)</a> for free, unbiased counseling on switching Medigap carriers.</div>
