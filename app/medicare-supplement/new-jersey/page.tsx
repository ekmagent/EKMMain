  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-4 py-10">
        ...
        <p className="text-sm text-gray-500 mt-2">By <strong>Anthony Orner</strong>, Independent Licensed Medicare Insurance Broker — appointed with multiple carriers, NJ &amp; 34 states</p>
