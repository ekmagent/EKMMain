...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const static_pages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/medicare-broker/new-jersey/ocean-county`, lastModified: pageMtime("medicare-broker/new-jersey/ocean-county"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/medicare-broker/new-jersey/monmouth-county`, lastModified: pageMtime("medicare-broker/new-jersey/monmouth-county"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${SITE_URL}/medicare-broker/new-jersey/union-county`, lastModified: pageMtime("medicare-broker/new-jersey/union-county"), changeFrequency: "monthly", priority: 0.8 },
