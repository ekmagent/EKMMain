...
export const metadata: Metadata = {
  title: "About Anthony Orner | Licensed NJ Medicare Broker 2026",
  description:
    "Meet Anthony Orner, an independent Medicare broker in NJ serving 35 states. Get free, unbiased Medigap & Advantage plan comparisons today.",
    ...
    <>
      ...
      <section className="max-w-3xl mx-auto px-6 py-14">
        ...
        <h1 className="text-4xl font-black tracking-tight text-[#1C2B27] mb-4">
          Meet Your Independent, Licensed Medicare Broker
        </h1>
