...
,
  {
    question: "How do I appeal IRMAA if my income has dropped?",
    answer:
      "If you had a qualifying life-changing event — such as retirement, divorce, or the death of a spouse — you can request a reduction by filing Form SSA-44 with the Social Security Administration. Include documentation of the event and evidence of your reduced income. SSA will review your request and, if approved, adjust your IRMAA amount. Call 855-559-1700 if you need help understanding your options.",
  },
  {
    question: "Is IRMAA permanent once I start paying it?",
    answer:
      "No. IRMAA is recalculated every year based on your tax return from two years prior. If your income drops below the threshold in a future tax year, your IRMAA surcharge will be reduced or removed automatically. You do not need to reapply each year unless you are appealing based on a life-changing event.",
  },
  {
    question: "How is IRMAA paid?",
    answer:
...
,
  {
    question: "How do I appeal an IRMAA determination if my income has dropped?",
    answer:
      "If you've experienced a life-changing event that reduced your income, you can file Form SSA-44 with the Social Security Administration to request a lower IRMAA. Qualifying events include retirement, marriage, divorce, death of a spouse, or loss of pension income. Submit the form with documentation to your local SSA office, and if approved, they will use your more recent income to calculate your surcharge.",
  },
  {
    question: "Is IRMAA recalculated every year?",
    answer:
      "Yes. Social Security reviews your tax return data from the IRS every year and recalculates whether you owe IRMAA based on your most recent available return. If your income drops below the threshold in a future year, the surcharge will be removed automatically once SSA receives the updated tax data.",
  },
  {
    question: "How is the IRMAA surcharge paid?",
    answer:
...
,
  {
    question: "How do I appeal an IRMAA determination?",
    answer:
      "If you had a qualifying life-changing event that reduced your income, you can appeal by filing Form SSA-44 with the Social Security Administration. Qualifying events include marriage, divorce, death of a spouse, work stoppage or reduction, loss of pension, or loss of income-producing property. You'll need documentation such as a marriage certificate, death certificate, or employer statement. Call 855-559-1700 for help understanding the process.",
  },
  {
    question: "Will IRMAA go away if my income drops?",
    answer:
      "Yes. Because IRMAA is recalculated each year based on your tax return from two years prior, a drop in income will eventually reduce or eliminate the surcharge. If the income drop was caused by a qualifying life-changing event, you can file Form SSA-44 to have IRMAA adjusted sooner rather than waiting two years.",
  },
  {
