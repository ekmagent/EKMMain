...
export const metadata: Metadata = {
  ...
  description:
    "Enroll in a Medicare Supplement plan in 5 steps and lock in your 6-month guaranteed-issue window. Call 855-559-1700 to compare every carrier at no cost.",
