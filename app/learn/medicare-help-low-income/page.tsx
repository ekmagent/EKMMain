...
export const metadata: Metadata = {
  ...
  description:
    "Lower your Medicare costs with Extra Help, QMB, SLMB & Medicare Savings Programs. See if you qualify — free guidance from a licensed broker. Call 855-559-1700.",
